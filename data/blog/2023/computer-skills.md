---
title: '计算机相关的技能'
date: Tue Jun 13 2023 13:53:39 GMT+0800 (中国标准时间)
lastmod: '2023-06-13'
tags: ['操作系统', 'linux']
draft: false
...
canonicalUrl: https://dume.vercel.app/blog/2023/computer-skills
---
...
- 计算机架构(computer architecture)： 在计算机工程中，计算机体系结构是描述计算机系统功能，组织和实现的- 一组规则和方法。它主要包括指令集、内存管理、I/O 和总线结构
...
其实，打开活动监视器，里面的都是进程。其实就是应用程序的实例
...
- 进程是操作系统中运行的应用程序的实例
- 线程是进程中的执行单元，线程是操作系统调度的基本单位
- JavaScript 引擎只有一个主线程，用于执行 JavaScript 代码。这是因为 JavaScript 最初是为了在网页浏览器中执行脚本而设计的，而网页的交互和渲染需要保持同步和顺序。如果 JavaScript 是多线程的，多个线程之间可能会相互竞争资源，导致不可预测的结果和性能问题。
